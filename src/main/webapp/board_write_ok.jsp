...
String uploadPath = "D:\\dev_choi\\jsp_lesson\\photo\\src\\main\\webapp\\upload";//물리적 경로 업로드 되는 경로를 얘기함
int maxFileSize = 1024 * 1024 * 20; //용량제한 20메가까지
String encType = "UTF-8";//인코딩값은 utf-8로
...
<!-- 
encType 속성값 목록
multiPart/form-data : 파일 업로드시(인코딩 하지 않음)
